...
export default function App() {
          ...
          {!isFirebaseConfigured && (
            <div className="pt-5 border-t border-slate-100 space-y-3">
              <div className="flex items-center space-x-1">
                ...
                <span className="text-[10px] uppercase font-bold text-indigo-700 font-mono tracking-wider">Inspect Security Clearance Roles</span>
              </div>
              ...
              <div className="grid grid-cols-3 gap-2 text-center text-[10px] font-extrabold font-mono">
                ...
                <button
                  ...
                  className="py-2.5 rounded border border-slate-200 hover:bg-amber-50 text-amber-700 hover:border-amber-200 transition bg-white block cursor-pointer"
                >
                  Manager
                </button>
                <button
  ...
  return (
    <div className="min-h-screen bg-slate-50 flex flex-col md:flex-row font-sans overflow-hidden">
      ...
      {toast && (
        <div className="fixed bottom-5 right-5 z-50 flex items-center space-x-2.5 p-4 rounded-xl shadow-2xl border bg-white animate-in slide-in-from-bottom-5 duration-200 border-slate-100 select-none">
          ...
          <div className="text-slate-800 text-xs font-semibold leading-normal max-w-sm">
            {toast.message}
          </div>
        </div>
      )}
